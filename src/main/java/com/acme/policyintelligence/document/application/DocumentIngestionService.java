...
import com.acme.policyintelligence.chunking.ChunkerRegistry;
import com.acme.policyintelligence.document.domain.Document;
import com.acme.policyintelligence.document.domain.DocumentChunk;
...
import com.acme.policyintelligence.document.infrastructure.DocumentChunkRepository;
import com.acme.policyintelligence.document.infrastructure.DocumentRepository;
import com.acme.policyintelligence.document.infrastructure.DocumentVersionRepository;
...
public class DocumentIngestionService {
    ...
    private int effectiveOverlap(IngestDocumentCommand command) {
        return command.chunkingStrategy() == com.acme.policyintelligence.document.domain.ChunkingStrategy.FIXED_SIZE
                ? 0
